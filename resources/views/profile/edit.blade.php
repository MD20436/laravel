...
<head>
    ...
    <!-- Domyślny styl -->
    <link id="theme-stylesheet" rel="stylesheet" href="{{ asset('global.css') }}">
...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="text-center mb-4">
            <!-- Przełącznik stylów -->
            <button id="background-default" class="btn btn-primary">Default Background</button>
            <button id="background-alternate" class="btn btn-secondary">Alternate Background</button>
        </div>
